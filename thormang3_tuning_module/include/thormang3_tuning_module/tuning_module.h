...
class TuningModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<TuningModule>
{
 public:
  ...
  void jointOffsetDataCallback(const thormang3_tuning_module_msgs::JointOffsetData::ConstPtr &msg);
  void jointGainDataCallback(const thormang3_tuning_module_msgs::JointOffsetData::ConstPtr &msg);
  void jointTorqueOnOffCallback(const thormang3_tuning_module_msgs::JointTorqueOnOffArray::ConstPtr& msg);
  bool getPresentJointOffsetDataServiceCallback(thormang3_tuning_module_msgs::GetPresentJointOffsetData::Request &req,
